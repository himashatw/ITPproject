							...
							<center>
								<div class="form-group" style="width: 200px;">
									<input type="submit" value="Arrange"
										...
										<a href="HallListController">List</a>
								</div>
							</center>
						</form>
					</div>
