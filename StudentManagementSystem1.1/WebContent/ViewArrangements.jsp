...
<body>
	...
	<div class="container">
		<div
			...
			<div class="col-md-9 ftco-animate text-center">
				<h1 class="mb-2 bread">Current Arrangements</h1>
				<p class="breadcrumbs">
					<span class="mr-2"><a href="index.jsp">Home <i
							class="ion-ios-arrow-forward"></i></a></span> <span><a
						href="dashboard.jsp">Office Admin <i
							class="ion-ios-arrow-forward"></i></a></span><span> Arrangements <i
	...
	<div
		style="padding-right: 100px; padding-left: 100px; padding-top: 3%; padding-bottom: 3%; text-align: center; font-weight: 500;">
		<table class="table table-bordered">
			...
			<tbody>
				...
				<c:forEach var="HallArrangements" items="${listHalls}">

					<tr>
						<td><c:out value="${HallArrangements.getReserveId()}" /></td>
						<td><c:out value="${HallArrangements.getHallNumber()}" /></td>
						<td><c:out value="${HallArrangements.getTeacherName()}" /></td>
						<td><c:out value="${HallArrangements.getTeacherId()}" /></td>
						<td><c:out value="${HallArrangements.getType()}" /></td>
						<td><c:out value="${HallArrangements.getSubject()}" /></td>
						<td><c:out value="${HallArrangements.getGrade()}" /></td>
						<td><c:out value="${HallArrangements.getDay()}" /></td>
						<td><c:out value="${HallArrangements.getStartTime()}" /></td>
						<td><c:out value="${HallArrangements.getEndTime()}" /></td>
						<td><a
							href="SelectedHallDataController?ReservationId=<c:out value='${HallArrangements.getReserveId()}' />">Edit</a>
							&nbsp;&nbsp;&nbsp;&nbsp; <a
							href="HallDeleteController?ReservationId=<c:out value='${HallArrangements.getReserveId()}' />">Delete</a></td>
					</tr>
				</c:forEach>
